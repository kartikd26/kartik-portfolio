...
const demos = [
  ...
  },
  {
    ...
    duration: "End-to-end",
    desc: "Live footage: uploading a real vendor invoice, watching OCR extract fields, approval workflow triggering automatically.",
    youtubeId: null as string | null,
    videoSrc: "/demos/invoice-ocr.mp4" as string | null,
    thumbnail: null as string | null,
  },
  {
    title: "BOM Mapper — Walkthrough",
    duration: "End-to-end",
    desc: "Mapping a multi-column BOM file to the system schema with fuzzy matching and live DigiKey/Mouser validation.",
    youtubeId: null as string | null,
    videoSrc: "/demos/bom-mapper.mp4" as string | null,
    thumbnail: null as string | null,
  },
];
